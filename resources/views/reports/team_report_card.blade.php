...
@section('title', 'Team Report Card')

@section('content')
<div class="pagetitle">
    <div class="row">
      <div class="col-6">
        <h1>Team Report Card</h1>
      </div>
    </div>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
        <li class="breadcrumb-item active"><a href="{{ route('reports.team_report_card') }}">Team Report Card</a></li>
      </ol>
    </nav>
</div>
...
<div class="card mb-3">
    <div class="card-body">
        <h5 class="card-title mb-0">Team Report Card</h5>
        <div class="card-content p-2">
            {{ Form::open(['route' => 'reports.team_report_card.post', 'method' => 'POST', 'target' => '_blank']) }}
                <div class="row mb-3">
